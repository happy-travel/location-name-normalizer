...
namespace HappyTravel.LocationNameNormalizer.UnitTests
{
    public class HtmlNormalizerTests
    {
        ...
        {
            var html =
                @"<p ar=""jkjl""><b>Property Location</b> <br />With a stay at Marriott Hotel Downtown, Abu Dhabi, you''ll be centrally located in Abu
    ...
    Khalifa Medical City and Al Nahyan Stadium.</p>";
            ...
            var outerHtml =
                @"<p><b>Property Location</b> <br>With a stay at Marriott Hotel Downtown, Abu Dhabi, you''ll be centrally located in Abu
    Dhabi, steps from Al Wahda Mall and Caracal Shooting Club. This 5-star hotel is within close proximity of Shaikh
    Khalifa Medical City and Al Nahyan Stadium.</p>";
    ...
    Khalifa Medical City and Al Nahyan Stadium.</p>";
        ...
        {
            var html =
                @"<p><h1>Property <i>Location</i></h1> With a stay at Marriott Hotel Downtown, Abu Dhabi, you''ll be centrally located in Abu
    Dhabi, steps from Al Wahda Mall and Caracal Shooting Club. This 5-star hotel is within close proximity of Shaikh
    Khalifa Medical City and Al Nahyan Stadium.</p>
    ...
    Khalifa Medical City and Al Nahyan Stadium.</h1>";
            ...
            var outerHtml =
                @"<p><b>Property <i>Location</i></b><br> With a stay at Marriott Hotel Downtown, Abu Dhabi, you''ll be centrally located in Abu
    Dhabi, steps from Al Wahda Mall and Caracal Shooting Club. This 5-star hotel is within close proximity of Shaikh
    Khalifa Medical City and Al Nahyan Stadium.</p>
    ...
    Khalifa Medical City and Al Nahyan Stadium.<br /><br /><br /></p>";
            ...
            var outerHtml =
                @"<p><ul>Property Location</ul> With a stay at Marriott Hotel Downtown, Abu Dhabi, you''ll be centrally located in Abu
    Dhabi, steps from Al Wahda Mall and Caracal Shooting Club. This 5-star hotel is within close proximity of Shaikh
    Khalifa Medical City and Al Nahyan Stadium.</p>";
